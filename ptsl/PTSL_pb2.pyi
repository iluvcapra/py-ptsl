...
SDK_Version_Mismatch: CommandErrorType
...
class ExportMixRequestBody(_message.Message):
    __slots__ = ["audio_info", "dolby_atmos_info", "file_name", "file_type", "files_list", "location_info", "offline_bounce", "preset_path", "video_info"]
...
class RenameTargetTrackRequestBody(_message.Message):
    __slots__ = ["new_name", "track_id"]
    NEW_NAME_FIELD_NUMBER: _ClassVar[int]
    TRACK_ID_FIELD_NUMBER: _ClassVar[int]
    new_name: str
    track_id: str
    def __init__(self, track_id: _Optional[str] = ..., new_name: _Optional[str] = ...) -> None: ...
